<template>
	<div>
		...
		> 
			<section v-show="open" class="fixed inset-0 overflow-hidden z-50" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
							...
							<div v-show="open" class="relative w-screen max-w-md">
								...
								<div class="h-full flex flex-col bg-white shadow-xl overflow-y-scroll">
									<div class="px-4 sm:px-6 py-8 bg-blue-600">
										<h2 class="text-2xl sm:text-3xl font-medium text-white" id="slide-over-title">
											{{ title }}
										</h2>
