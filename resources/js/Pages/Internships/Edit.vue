<template>
	<breeze-authenticated-layout>
		<div class="max-w-3xl mx-auto mt-6">
			...
			>
				<div class="grid gap-x-3 gap-y-6">
					<div class="col-span-6 sm:col-span-6">
						<label for="title" class="required">Title</label>
						<input v-model="form.title" type="text" name="title" id="title" class="mt-1.5 form-control" />
					</div>
					<div class="col-span-2">
						<label for="field" class="required">Field of studies</label>
						<select v-model="form.field_id" name="field" id="field" class="mt-1.5 form-control">
							<option></option>
					...
					<div class="col-span-2">
						...
						<select v-model="form.company_supervisor_id" name="supervisor" id="supervisor" class="mt-1.5 form-control">
							<option></option>
					...
					<div class="col-span-2">
						...
						<input v-model="form.closing_at" name="closing_at" id="closing_at" type="date" class="mt-1.5 form-control" />
					</div>
					<div class="col-span-6">
						<label for="description" class="required">Description</label>
						<textarea v-model="form.description" name="description" id="description" rows="12" class="mt-1.5 form-control"></textarea>
					</div>
					<div class="col-span-6">
					...
					<div class="col-span-6">
						...
						<p class="mt-1.5 text-gray-500 text-sm font-light">You may attach up to 10 files under the size of <span class="font-semibold">10MB</span> each.</p>
					</div>
				</div>
			</app-form>
		</div>
